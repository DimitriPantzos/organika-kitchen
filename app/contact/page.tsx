            ...
            <div className="space-y-6">
              ...
              <Card className="border-border/50">
                <CardContent className="space-y-4 p-6">
                  <div>
                    ...
                    <p className="font-script text-lg text-berry-500">
                      Southport, CT
                    </p>
                  </div>
                  ...
                  <div className="space-y-3 text-sm text-muted-foreground">
                    ...
                    <div className="flex items-center gap-2">
                      <Phone className="h-4 w-4 shrink-0 text-berry-500" />
                      <a
                    ...
                    <div className="flex items-start gap-2">
                      <Clock className="mt-0.5 h-4 w-4 shrink-0 text-berry-500" />
                      <div>
              ...
              <div className="flex items-center gap-6 rounded-lg border border-border bg-card p-4">
                <div className="flex items-center gap-3">
                  <Instagram className="h-5 w-5 text-berry-500" />
                  <div>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-sm text-berry-500 hover:text-berry-400"
                    >
                ...
                <div className="flex items-center gap-3">
                  <Facebook className="h-5 w-5 text-berry-500" />
                  <div>
