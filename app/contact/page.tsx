            ...
            <div className="space-y-6">
                ...
                <CardContent className="space-y-4 p-6">
                  ...
                  <div className="space-y-3 text-sm text-muted-foreground">
                    <div className="flex items-start gap-2">
                      <MapPin className="mt-0.5 h-4 w-4 shrink-0 text-garden-500" />
                      <a
                    ...
                    <div className="flex items-center gap-2">
                      <Phone className="h-4 w-4 shrink-0 text-garden-500" />
                      <a
                    ...
                    <div className="flex items-start gap-2">
                      <Clock className="mt-0.5 h-4 w-4 shrink-0 text-garden-500" />
                      <div>
              ...
              <div className="flex items-center gap-4 rounded-lg border border-border bg-card p-4">
                <div className="flex items-center gap-3">
                  <Instagram className="h-5 w-5 text-garden-500" />
                  <div>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-sm text-garden-500 hover:text-garden-600"
                    >
                ...
                <div className="flex items-center gap-3">
                  <Facebook className="h-5 w-5 text-garden-500" />
                  <div>
